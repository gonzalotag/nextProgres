            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
              {exercises.map((exercise, index) => (
                <div key={index} className="p-4 border rounded-lg shadow-md">
                  ...
                  <h2 className="mt-2 font-bold">{exercise.nombre || exercise.tituloPlantilla}</h2>
                  <p className="text-sm text-gray-600">{exercise.description || exercise.textoEjercicio}</p>
                </div>
              ))}
            </div>
          )}
